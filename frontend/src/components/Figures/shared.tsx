...
export const getYAxisOptions = (year: number) => [
  {
    ...
    matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.epa ?? 0,
    value: "total_epa",
    label: "Total EPA",
  },
  ...(year >= 2016
    ? [
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.auto_epa ?? 0,
          value: "auto_epa",
          label: "Auto EPA",
        },
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.teleop_epa ?? 0,
          value: "teleop_epa",
          label: "Teleop EPA",
        },
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.endgame_epa ?? 0,
          value: "endgame_epa",
          label: "Endgame EPA",
        },
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.rp_1_epa ?? 0,
          value: "rp_1_epa",
        ...
        },
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.rp_2_epa ?? 0,
          value: "rp_2_epa",
    ...
    ? [
        {
          ...
          matchAccessor: (teamMatch: APITeamMatch) => teamMatch?.rp_3_epa ?? 0,
          value: "rp_3_epa",
