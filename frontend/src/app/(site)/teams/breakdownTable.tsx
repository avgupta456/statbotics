...
export type TeamYearBreakdown2024 = {
  num: string;
  team: string;
  epa_rank: number;
...
const columnHelper = createColumnHelper<TeamYearBreakdown2024>();

const detailedColumnHelper = createColumnHelper<any>();

const PageTeamBreakdownTable = ({
  year,
  data,
  filters,
  setFilters,
  ...
  const yearBreakdownData: TeamYearBreakdown2024[] = filterData(allTeamYears, actualFilters)
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <InsightsTable
        ...
        columns={columns}
        detailedData={yearBreakdownData}
        detailedColumns={detailedColumns}
        searchCols={["num", "team"]}
        csvFilename={`${year}_breakdown.csv`}
...
export default PageTeamBreakdownTable;
