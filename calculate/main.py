...
# process_tba.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean, cache) # 20 minutes  # noqa 502
# process_avg.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 5 seconds  # noqa 502
# process_elo.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 18 minutes  # noqa 502
# process_opr.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 23 minutes  # noqa 502
