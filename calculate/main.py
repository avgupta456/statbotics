...
# process_tba.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean, cache) # 20 minutes
# process_avg.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 5 seconds
# process_elo.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 18 minutes
# process_opr.main(start_year, end_year, TBA, SQL_Write, SQL_Read, clean) # 23 minutes
