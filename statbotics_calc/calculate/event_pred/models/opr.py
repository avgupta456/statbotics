...
def get_ixOPR(event, year, quals, playoffs, teams, team_stats, team_matches,
...
def get_ILS(event, quals, teams, team_stats, team_matches):
    min_ils = -1/3
...
def get_oprs(event, year, quals, playoffs, teams, team_stats, team_matches, mean_score):  # noqa 502
    OPRs = get_ixOPR(event, year, quals, playoffs, teams, team_stats,
