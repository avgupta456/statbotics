...
from src.epa.constants import INIT_PENALTY, MEAN_REVERSION, MIN_RP_EPA, YEAR_ONE_WEIGHT
...
def norm_epa_to_next_season_epa(
    ...
    return max(curr_mean / curr_num_teams + curr_sd * norm_epa, 0)
...
def get_init_epa(
    ...
    norm_epa_1 = norm_epa_2 = -INIT_PENALTY
