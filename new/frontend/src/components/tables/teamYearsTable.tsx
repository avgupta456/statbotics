...
import { CURR_YEAR, RP_KEYS, RP_NAMES } from "../../utils/constants";
...
export default function TeamYearsTable({
  ...
  const getColumnDefs = (newYear: number, newExpanded: boolean) =>
    [
      ...
      newYear >= 2016 && newExpanded && getEPADef(RP_KEYS[newYear][0], RP_NAMES[newYear][0]),
      newYear >= 2016 && newExpanded && getEPADef(RP_KEYS[newYear][1], RP_NAMES[newYear][1]),
