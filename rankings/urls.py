...
urlpatterns = [
    ...
    path('api/teams/country/<country>/by/<elo>', views.TeamsCountry_byElo.as_view()),
    path('api/teams/country/<country>/active', views.TeamsCountryActive.as_view()),
    path('api/teams/country/<country>/active/by/<elo>', views.TeamsCountryActive_byElo.as_view()),

    path('api/teams/country/<country>/state/<state>', views.TeamsState.as_view()),
    path('api/teams/country/<country>/state/<state>/by/<elo>', views.TeamsState_byElo.as_view()),
    path('api/teams/country/<country>/state/<state>/active', views.TeamsStateActive.as_view()),
    path('api/teams/country/<country>/state/<state>/active/by/<elo>', views.TeamsStateActive_byElo.as_view()),

    path('api/teams/year/<year>', views.TeamsYear.as_view()),
    path('api/teams/year/<year>/by/<elo>', views.TeamsYear_byElo.as_view()),

    path('api/teams/district/<district>/years', views.TeamsDistrict_Years.as_view()),
    path('api/teams/district/<district>/years/by/<elo>', views.TeamsDistrict_Years_byElo.as_view()),
    path('api/teams/district/<district>/year/<year>', views.TeamsDistrictYear.as_view()),
    path('api/teams/district/<district>/year/<year>/by/<elo>', views.TeamsDistrictYear_byElo.as_view()),

    path('api/teams/country/<country>/years', views.TeamsCountry_Years.as_view()),
    path('api/teams/country/<country>/years/by/<elo>', views.TeamsCountry_Years_byElo.as_view()),
    path('api/teams/country/<country>/year/<year>', views.TeamsCountryYear.as_view()),
    path('api/teams/country/<country>/year/<year>/by/<elo>', views.TeamsCountryYear_byElo.as_view()),

    path('api/teams/country/<country>/state/<state>/years', views.TeamsState_Years.as_view()),
    path('api/teams/country/<country>/state/<state>/years/by/<elo>', views.TeamsState_Years_byElo.as_view()),
    path('api/teams/country/<country>/state/<state>/year/<year>', views.TeamsStateYear.as_view()),
    path('api/teams/country/<country>/state/<state>/year/<year>/by/<elo>', views.TeamsStateYear_byElo.as_view()),
