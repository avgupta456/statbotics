...
urlpatterns = [
    ...
    path('api/teams/region/<region>/years', views.TeamsRegion_Years.as_view()),
    path('api/teams/region/<region>/years/by/<elo>', views.TeamsRegion_Years_byElo.as_view()),
    ...
    path('api/teams/region/<region>/year/<year>', views.TeamsRegionYear.as_view()),
    path('api/teams/region/<region>/year/<year>/by/<elo>', views.TeamsRegionYear_byElo.as_view()),
