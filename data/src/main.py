...
# from process.process_avg import main as process_avg
# from process.process_elo import main as process_elo
from process.process_opr import main as process_opr

# from process.process_tba import main as process_tba
