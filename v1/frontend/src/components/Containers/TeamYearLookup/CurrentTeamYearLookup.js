...
export default function TeamLookup() {
  ...
  const columns = [
    ...
    ["OPR", false, true, false, "Assumes Week 1 mean score of 30"],
    ["Auto", false, true, false, "Assumes Week 1 mean score of 10"],
    ["Teleop", false, true, false, "Assumes Week 1 mean score of 10"],
    ["Endgame", false, true, false, "Assumes Week 1 mean score of 10"],
    [
      ilsMapping[year][0],
      false,
      true,
      false,
      "ILS score (higher is better). Assumes Week 1 20% completion rate",
    ],
    [
      ilsMapping[year][1],
      false,
      true,
      false,
      "ILS score (higher is better). Assumes Week 1 10% completion rate",
    ],
