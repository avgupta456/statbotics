...
!(function (t, e) {
  ...
  function ut(t) {
    ...
    return (
      void 0 === e &&
        ((e = st(t)), Tr === Lr && ((Tr = 0), (Br = {})), Tr++, (Br[t] = e)),
      e
    );
  }
  function st(t) {
  ...
  function at(t) {
    ...
    if (!Ar) {
      if (
        ((e = t.propertyIsEnumerable && t.propertyIsEnumerable[Ur]),
        void 0 !== e)
      )
        return e;
  ...
  function Et(t, e, r, n) {
    for (
      var i = 0, o = 0, u = Array(r), s = 0, a = 1, h = e.length;
      h > s;
      s++, a <<= 1
    ) {
      var f = e[s];
  ...
  function Ot(t, e, r, n, i) {
    for (var o = 0, u = Array(vr), s = 0; 0 !== r; s++, r >>>= 1)
      u[s] = 1 & r ? e[o++] : void 0;
  ...
  function Xt(t, e, r) {
    ...
    for (var a = t._level, h = t._root, f = 0; 0 > u + f; )
      (h = new Ct(h && h.array.length ? [void 0, h] : [], n)),
        (a += pr),
        (f += 1 << a);
    f && ((u += f), (i += f), (s += f), (o += f));
  ...
  (Cr[Wr] = !0),
    ...
    (pt.prototype.update = function (t, e, r, n, i, o, u) {
      for (
        var s = i === yr, a = this.entries, h = 0, f = a.length;
        f > h && !X(n, a[h][0]);
        h++
      );
      var _ = f > h;
    ...
    (vt.prototype.get = function (t, e, r, n) {
      ...
      return 0 === (o & i)
        ? n
        : this.nodes[Ut(o & (i - 1))].get(t + pr, e, r, n);
    }),
    ...
    (yt.prototype.update = function (t, e, r, n, i, o, u) {
      ...
      for (
        var a = this.entries, h = 0, f = a.length;
        f > h && !X(n, a[h][0]);
        h++
      );
      var _ = f > h;
  ...
  (Yr[Vr] = !0),
    ...
    (Ct.prototype.removeAfter = function (t, e, r) {
      ...
      if (e > 0) {
        var o = this.array[n];
        if (
          ((i = o && o.removeAfter(t, e - pr, r)),
          i === o && n === this.array.length - 1)
        )
          return this;
      }
      var u = Yt(this, t);
  ...
  (an[hr] = !0),
    ...
    Fe(n, {
      ...
      splice: function (t, e) {
        ...
        return be(
          this,
          1 === r ? n : n.concat(p(arguments, 2), this.slice(t + e))
        );
      },
