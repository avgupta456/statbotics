...
for (var p in redocSettings) {
  if (redocSettings.hasOwnProperty(p)) {
    if (
      redocSettings[p] !== null &&
      redocSettings[p] !== undefined &&
      redocSettings[p] !== false
    ) {
