...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (function (t) {
        ...
        var r = n(142),
          ...
          y = n(0),
          v = n.n(y),
          g = (n(229), n(230), n(138), n(139)),
          w = n.n(g),
          M = (n(231), n(144), n(52), n(70), n(145), n(73)),
          m =
            (n(234),
            n(235),
            n(236),
    ...
    function (t, e, n) {
      ...
      var r = n(60),
        i = n(174),
        o = (n(120), n(172), Object.prototype.hasOwnProperty),
        u = n(175),
    ...
    function (t, e, n) {
      ...
      }.call(this, n(37), n(206).setImmediate, n(21)));
    },
    function (t, e, n) {
      "use strict";
      t.exports = function (t) {
    ...
    function (t, e, n) {
      ...
      }.call(this, n(37), n(206).setImmediate));
    },
    function (t, e, n) {
      "use strict";
      var r = n(51);
    ...
    function (t, e, n) {
      ...
      var r = n(11),
        ...
        L = function t(e) {
          ...
          if (((n = (x ? x + ":" : "") + (b = b || "notagname")), j)) {
            var S = x ? "xmlns:" + x : "xmlns";
            m[S] = j;
          }
          if ("array" === s && l) {
            if (
              ((l.xml = l.xml || L || {}),
              (l.xml.name = l.xml.name || L.name),
              L.wrapped)
            )
              return (
                (w[n] = []),
                a()(d)
                  ? i()(d).call(d, function (e) {
                      (l.example = e), w[n].push(t(l, o));
                    })
                  : a()(g)
                  ? i()(g).call(g, function (e) {
                      (l.default = e), w[n].push(t(l, o));
                    })
                  : (w[n] = [t(l, o)]),
                m && w[n].push({ _attr: m }),
                w
            ...
            return a()(d)
              ? (i()(d).call(d, function (e) {
                  (l.example = e), D.push(t(l, o));
                }),
                D)
              : a()(g)
              ? (i()(g).call(g, function (e) {
                  (l.default = e), D.push(t(l, o));
                }),
                D)
              : t(l, o);
          }
          if ("object" === s) {
            var I = Object(h.d)(c);
            for (var A in ((w[n] = []), (d = d || {}), I))
              if (
                I.hasOwnProperty(A) &&
                (!I[A].readOnly || y) &&
                (!I[A].writeOnly || v)
              )
                if (((I[A].xml = I[A].xml || {}), I[A].xml.attribute)) {
                  var C = a()(I[A].enum) && I[A].enum[0],
                    E = I[A].example,
                    O = I[A].default;
                  m[I[A].xml.name || A] =
                    (void 0 !== E && E) ||
                  ...
                  (I[A].xml.name = I[A].xml.name || A),
                    void 0 === I[A].example &&
                      void 0 !== d[A] &&
                      (I[A].example = d[A]);
                  var T,
                    z = t(I[A]);
                  if (a()(z)) w[n] = p()((T = w[n])).call(T, z);
                  else w[n].push(z);
                }
            return (
              !0 === f
                ? w[n].push({ additionalProp: "Anything can be here" })
                : f && w[n].push({ additionalProp: _(f) }),
              m && w[n].push({ _attr: m }),
              w
            );
          }
          return (
            (r = void 0 !== d ? d : void 0 !== g ? g : a()(N) ? N[0] : _(e)),
            (w[n] = m ? [{ _attr: m }, r] : r),
            w
          );
        };
      var b = g()(function (t, e) {
          var n = L(t, e);
          if (n) return y()(n, { declaration: !0, indent: "\t" });
        }),
        x = g()(function t(e) {
          var n,
            r,
          ...
          if (void 0 !== c)
            return Object(h.a)(c, "$$ref", function (t) {
          ...
          if ("object" === s) {
            ...
            for (var M in g)
              (g[M] && g[M].deprecated) ||
                ...
                (g[M] && g[M].writeOnly && !v) ||
                (w[M] = t(g[M], i));
            if (!0 === p) w.additionalProp1 = {};
            else if (p)
              for (var m = Object(h.d)(p), L = t(m, i), b = 1; b < 4; b++)
                w["additionalProp" + b] = L;
            return w;
          }
          return "array" === s
            ? a()(d.anyOf)
              ? u()((n = d.anyOf)).call(n, function (e) {
                  return t(e, i);
                })
              : a()(d.oneOf)
              ? u()((r = d.oneOf)).call(r, function (e) {
                  return t(e, i);
                })
              : [t(d, i)]
            : e.enum
    ...
    function (t, e, n) {
      ...
      function a(t) {
        for (
          ...
          for (var l = o[f], p = Object.keys(l), h = 0; h < p.length; h++) {
            var d = p[h],
              y = l[d],
              v = i(y),
              g = i(c[d]);
    ...
    function (t, e, n) {
      n(1)({ target: "Object", stat: !0, sham: !n(22) }, { create: n(77) });
    },
    function (t, e, n) {
      var r = n(22),
        i = n(34),
    ...
    function (t, e, n) {
      n(1)({ target: "Object", stat: !0 }, { setPrototypeOf: n(154) });
    },
    function (t, e, n) {
      var r = n(15);
      t.exports = function (t) {
    ...
    function (t, e, n) {
      ...
      var r = n(1),
        i = n(338).trim;
      r(
        { target: "String", proto: !0, forced: n(339)("trim") },
        {
          trim: function () {
            return i(this);
          },
    ...
    function (t, e, n) {
      ...
      var r = n(1),
        ...
        o = n(42);
      r(
        { target: "String", proto: !0, forced: !n(181)("includes") },
        {
          includes: function (t) {
    ...
    function (t, e, n) {
      n(1)({ target: "Function", proto: !0 }, { bind: n(156) });
    },
    function (t, e, n) {
      var r = n(408);
      t.exports = r;
    ...
    function (t, e, n) {
      var r = n(495)(Object.keys, Object);
      t.exports = r;
    },
    function (t, e) {
      t.exports = function (t, e) {
    ...
    function (t, e, n) {
      t.exports = n(131).Transform;
    },
    function (t, e, n) {
      t.exports = n(131).PassThrough;
    },
    function (t, e, n) {
      "use strict";
      var r = n(538),
    ...
    function (t, e, n) {
      ...
      (t.exports.Type = n(8)),
        ...
        (t.exports.FAILSAFE_SCHEMA = n(137)),
        (t.exports.JSON_SCHEMA = n(220)),
        (t.exports.CORE_SCHEMA = n(219)),
        (t.exports.DEFAULT_SAFE_SCHEMA = n(69)),
        (t.exports.DEFAULT_FULL_SCHEMA = n(97)),
        ...
        (t.exports.YAMLException = n(68)),
        (t.exports.MINIMAL_SCHEMA = n(137)),
        (t.exports.SAFE_SCHEMA = n(69)),
        (t.exports.DEFAULT_SCHEMA = n(97)),
