...
urlpatterns = [
    ...
    path(
        "api/teams/country/<country>/active/by/<metric>", team_views._TeamsActive
    ),  # noqa 502
    ...
    path(
        "api/team_years/team/<num>/by/<metric>", team_year_views.TeamYearsNumByMetric
    ),  # noqa 502
    path("api/team_years/year/<year>", team_year_views.TeamYearsYear),
    path(
        "api/team_years/year/<year>/by/<metric>", team_year_views.TeamYearsYearByMetric
    ),  # noqa 502
    path(
    ...
    # TeamEvents
    path(
        "api/team_event/team/<num>/event/<event>", team_event_views.TeamEvent
    ),  # noqa 502
    path("api/team_events/team/<num>", team_event_views.TeamEventsNum),
    path(
        "api/team_events/team/<num>/by/<metric>", team_event_views.TeamEventsNumByMetric
    ),  # noqa 502
    path(
        "api/team_events/team/<num>/type/<type>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/team/<num>/week/<week>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/year/<year>/page/<page>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/year/<year>/type/<type>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/year/<year>/week/<week>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/year/<year>/country/<country>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/year/<year>/district/<district>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/country/<country>/page/<page>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
        "api/team_events/country/<country>/state/<state>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/district/<district>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
        "api/team_events/district/<district>/by/<metric>", team_event_views._TeamEvents
    ),  # noqa 502
    path("api/team_events/type/<type>", team_event_views._TeamEvents),
    path(
        "api/team_events/type/<type>/by/<metric>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
        "api/team_events/type/<type>/country/<country>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/type/<type>/district/<district>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/week/<week>/by/<metric>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
        "api/team_events/week/<week>/country/<country>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/week/<week>/district/<district>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    path(
        "api/team_events/type/<type>/week/<week>", team_event_views._TeamEvents
    ),  # noqa 502
    path(
    ...
    # TeamMatches
    path(
        "api/team_match/team/<num>/match/<match>", team_match_views.TeamMatch
    ),  # noqa 502
    ...
    path(
        "api/team_matches/page/<page>/elims", team_match_views._TeamMatchesElim
    ),  # noqa 502
    path("api/team_matches/team/<num>", team_match_views.TeamMatchesTeam),
    path(
        "api/team_matches/team/<num>/elims", team_match_views._TeamMatchesElim
    ),  # noqa 502
    path("api/team_matches/year/<year>", team_match_views.TeamMatchesYear),
    path(
        "api/team_matches/year/<year>/elims", team_match_views._TeamMatchesElim
    ),  # noqa 502
    path(
        "api/team_matches/year/<year>/page/<page>", team_match_views._TeamMatches
    ),  # noqa 502
    path(
        "api/team_matches/year/<year>/page/<page>", team_match_views._TeamMatchesElim
    ),  # noqa 502
    path("api/team_matches/event/<event>", team_match_views.TeamMatchesEvent),
    path(
        "api/team_matches/event/<event>/elims", team_match_views._TeamMatchesElim
    ),  # noqa 502
    path("api/team_matches/match/<match>", team_match_views.TeamMatchesMatch),
    path(
        "api/team_matches/team/<num>/year/<year>", team_match_views.TeamMatchesTeamYear
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/country/<country>/state/<state>/by/<metric>", event_views._Events
    ),  # noqa 502
    ...
    path(
        "api/events/type/<type>/country/<country>/state/<state>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/type/<type>/district/<district>/by/<metric>", event_views._Events
    ),  # noqa 502
    ...
    path(
        "api/events/week/<week>/country/<country>/state/<state>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/week/<week>/district/<district>/by/<metric>", event_views._Events
    ),  # noqa 502
    path("api/events/type/<type>/week/<week>", event_views._Events),
    path(
        "api/events/type/<type>/week/<week>/by/<metric>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/type/<type>/week/<week>/district/<district>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/country/<country>/state/<state>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/district/<district>/by/<metric>", event_views._Events
    ),  # noqa 502
    path("api/events/year/<year>/type/<type>", event_views._Events),
    path(
        "api/events/year/<year>/type/<type>/by/<metric>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/type/<type>/district/<district>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/week/<week>/by/<metric>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/week/<week>/district/<district>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/events/year/<year>/type/<type>/week/<week>", event_views._Events
    ),  # noqa 502
    path(
    ...
    path(
        "api/event_sim/event/<event>/full/iterations/<iterations>", event_pred_views.Sim
    ),  # noqa 502
    path(
