...
def process_year(year: Year, matches: List[Match]) -> Year:
    ...
    if year.year == 2026:
        # Seeded from 2026week0 preseason event (31 matches)
        # TODO: Remove once week 1 data is available
        year.score_mean = 114.40
        year.score_sd = 59.39
        year.no_foul_mean = 108.19
        year.foul_mean = 6.21
        year.auto_mean = 20.55
        year.teleop_mean = 61.10
        year.endgame_mean = 26.55
        year.rp_1_mean = 0.18
        year.rp_2_mean = 0.0
        year.rp_3_mean = 0.0
        year.tiebreaker_mean = 108.19
        year.comp_1_mean = 20.31  # auto_fuel
        year.comp_2_mean = 0.24  # auto_tower
        year.comp_3_mean = 3.98  # transition_fuel
        year.comp_4_mean = 28.95  # first_shift_fuel
        year.comp_5_mean = 28.16  # second_shift_fuel
        year.comp_6_mean = 61.10  # teleop_fuel
        year.comp_7_mean = 25.10  # endgame_fuel
        year.comp_8_mean = 1.45  # endgame_tower
        year.comp_9_mean = 106.50  # total_fuel
        year.comp_10_mean = 1.69  # total_tower
