...
def process_year(year: Year, matches: List[Match]) -> Year:
    ...
    if year.year == CURR_YEAR and N < 100:
        ...
        year.comp_2_mean = 0.13
        year.comp_3_mean = 2.63
        year.comp_4_mean = 2.76
        year.comp_5_mean = 13.4
        year.comp_6_mean = 2.47
        year.comp_7_mean = 6.73
        year.comp_8_mean = 0.95
        year.comp_9_mean = 9.19
        year.comp_10_mean = 18.77
