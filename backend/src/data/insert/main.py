...
from src.data.insert.utils import write_objs, print_table_stats
from src.data.insert.utils import time_func
...
def reset_current_year(curr_year: int, clean: bool = True):
